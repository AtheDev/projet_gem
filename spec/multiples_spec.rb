...
describe "the sum_of_3_and_5_multiples method" do
  it "should return sum of 3 and 5 multiples" do
  ...
  it "should return TG" do
    ...
    expect(sum_of_3_and_5_multiples("chiffre")).to eq("Yo ! Je ne prends que les entiers naturels. TG")
  end
end